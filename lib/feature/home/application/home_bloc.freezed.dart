...
mixin _$HomeState {
  ...
  List<AppGame> get games => throw _privateConstructorUsedError;
...
abstract class $HomeStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({Status status, List<AppGame> games});
...
class _$HomeStateImpl implements _HomeState {
  const _$HomeStateImpl(
      ...
      final List<AppGame> games = const <AppGame>[]})
      : _games = games;

  @override
  @JsonKey()
  final Status status;
  final List<AppGame> _games;
  @override
  @JsonKey()
  List<AppGame> get games {
  ...
  @override
  String toString() {
    return 'HomeState(status: $status, games: $games)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, status, const DeepCollectionEquality().hash(_games));
...
abstract class _HomeState implements HomeState {
  const factory _HomeState({final Status status, final List<AppGame> games}) =
      _$HomeStateImpl;
...
class __$$OnStartImplCopyWithImpl<$Res>
    extends _$HomeEventCopyWithImpl<$Res, _$OnStartImpl>
...
abstract class _OnStart implements HomeEvent {
  factory _OnStart() = _$OnStartImpl;
}
