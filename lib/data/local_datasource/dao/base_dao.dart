...
abstract class AppBaseDao<T> {
  ...
  Future<int> saveWithOutRelace(T data);
...
abstract class AppBaseDaoImpl<T extends AppBaseEntity> extends AppBaseDao<T> {
  ...
  @override
  Future<int> saveWithOutRelace(T data) async {
